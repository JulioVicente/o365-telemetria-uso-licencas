...
Na instalacao guiada, uma conta remetente com caixa Exchange Online e obrigatoria. O instalador valida o formato, exige login com a mesma conta, solicita `Mail.Send`, executa a coleta inicial e somente conclui depois que o Graph aceitar o envio ao destinatario e a copia oculta para `suprote@bestsoft.com.br`.
